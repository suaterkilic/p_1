...
import SocialMedias from "@/components/social_medias/SocialMedias";
const About = () => {
  return (
    <>
      <Header />
      ...
      <Team
        title="Who we are?"
        description="We always have a set of mindsets for our business"
      />
      <SocialMedias title="Join Our Social Media" />
    </>
  );
};
